...
/*! jQuery v3.7.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */ !function(e, t) {
    ...
    !function() {
        ...
        function V(e) {
            ...
            }), le.disconnectedMatch = $1(function(e) {
                return i.call(e, "*");
            }), le.scope = $1(function() {
                return T.querySelectorAll(":scope");
            }), le.cssHas = $1(function() {
                try {
    ...
    B.uid = 1, B.prototype = {
        cache: function(e) {
            ...
            return t || (t = {}, $1(e) && (e.nodeType ? e[this.expando] = t : Object.defineProperty(e, this.expando, {
                value: t,
                configurable: !0
            }))), t;
        },
    ...
    ce.extend({
        ...
        cleanData: function(e) {
            for(var t, n, r, i = ce.event.special, o = 0; void 0 !== (n = e[o]); o++)if ($1(n)) {
                if (t = n[_.expando]) {
    ...
    ce.extend(ce.event, {
        trigger: function(e, t, n, r) {
            ...
            if (o = f = a = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !Dt.test(d + ce.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[ce.expando] ? e : new ce.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [
                ...
                i = 0;
                while((o = p[i++]) && !e.isPropagationStopped())f = o, e.type = 1 < i ? s : c.bindType || d, (l = (_.get(o, "events") || Object.create(null))[e.type] && _.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && $1(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = d, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(p.pop(), t) || !$1(n) || u && v(n[d]) && !y(n) && ((a = n[u]) && (n[u] = null), ce.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, Nt), n[d](), e.isPropagationStopped() && f.removeEventListener(d, Nt), ce.event.triggered = void 0, a && (n[u] = a)), e.result;
            }
        },
...
async function updateImageDisplay(e) {
    ...
    for(let i = 0; i < selectedFiles.length; i++)upload(selectedFiles[i]);
}
async function upload(as) {
    let form = new FormData();
    form.append("file", as);
    let response = await fetch("https://codefoxy-server.hf.space/upload?logs=container", {
        method: "POST",
        body: form
    });
